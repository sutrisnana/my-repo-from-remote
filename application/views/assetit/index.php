<div class="container mb-2 mt-2" style="min-height: 37rem;">
          ...
          <tbody>
            <?php foreach ($asset as $ast) : ?>
              <tr>
                ...
                <td><a href="<?= base_url(); ?>assetit/historyPc/<?= $ast['idpc']; ?>" class="badge badge-primary historyPC">History</a></td>
                <td><a href="<?= base_url(); ?>assetit/detailPc/<?= $ast['id']; ?>" class="badge badge-info">Detail</a></td>
                <td><a href="<?= base_url(); ?>assetit/ubahPc/<?= $ast['id']; ?>" class="badge badge-secondary">Ubah</a></td>
                <td><a href="<?= base_url(); ?>assetit/hapusPc/<?= $ast['id']; ?>" class="badge badge-danger" onclick="return confirm('Hapus Data.?');">Hapus</a></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
          <tfoot>
